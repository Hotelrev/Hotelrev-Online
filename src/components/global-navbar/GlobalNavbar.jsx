import logo from 'assets/logos/HotelRev.png';
...
const GlobalNavbar = () => {
  ...
  return (
    <div className="relative flex flex-wrap justify-between items-center px-4 md:px-12 py-3 global-navbar__container bg-brand brand-divider-bottom">
      <div className="flex">
        <Link to="/">
          <img src={logo} alt="site logo" className="site-logo__img lg:w-[130px] w-[100px]" />
        </Link>
      </div>
